<?php  //[STAMP] 3f1809bef69e5e7823f77ae2bcbfd7e0
...
use Helper\Product_service;

trait Product_serviceTesterActions
{
    /**
     ...
     *
     *
     * @see \Helper\Product_service::removeProductBySku()
     */
    public function removeProductBySku($con, $sku) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('removeProductBySku', func_get_args()));
    }
}
