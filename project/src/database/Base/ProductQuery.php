...
namespace Nu3\Database\Model\Base;

use \Exception;
use \PDO;
use Nu3\Database\Model\Product as ChildProduct;
use Nu3\Database\Model\ProductQuery as ChildProductQuery;
use Nu3\Database\Model\Map\ProductTableMap;
 ...
 * @method     ChildProductQuery orderByRaw($order = Criteria::ASC) Order by the raw column
 * @method     ChildProductQuery orderByComputed($order = Criteria::ASC) Order by the computed column
 *
 ...
 * @method     ChildProductQuery groupByRaw() Group by the raw column
 * @method     ChildProductQuery groupByComputed() Group by the computed column
 *
 ...
 * @method     ChildProduct findOneByRaw(string $raw) Return the first ChildProduct filtered by the raw column
 * @method     ChildProduct findOneByComputed(string $computed) Return the first ChildProduct filtered by the computed column *
 ...
 * @method     ChildProduct requireOneByStatus(string $status) Return the first ChildProduct filtered by the status column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProduct requireOneByRaw(string $raw) Return the first ChildProduct filtered by the raw column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProduct requireOneByComputed(string $computed) Return the first ChildProduct filtered by the computed column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildProduct[]|ObjectCollection findByRaw(string $raw) Return ChildProduct objects filtered by the raw column
 * @method     ChildProduct[]|ObjectCollection findByComputed(string $computed) Return ChildProduct objects filtered by the computed column
...
abstract class ProductQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Nu3\Database\Model\Base\ProductQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'nu3_catalog', $modelName = '\\Nu3\\Database\\Model\\Product', $modelAlias = null)
    {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(ProductTableMap::COL_SKU, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ProductTableMap::COL_SKU, $keys, Criteria::IN);
    }
    ...
    /**
     * Filter the query on the raw column
     *
     * Example usage:
     * <code>
     * $query->filterByRaw('fooValue');   // WHERE raw = 'fooValue'
     * $query->filterByRaw('%fooValue%', Criteria::LIKE); // WHERE raw LIKE '%fooValue%'
     * </code>
     *
     * @param     string $raw The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildProductQuery The current query, for fluid interface
     */
    public function filterByRaw($raw = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($raw)) {
                $comparison = Criteria::IN;
        ...
        return $this->addUsingAlias(ProductTableMap::COL_RAW, $raw, $comparison);
    }

    /**
     * Filter the query on the computed column
     *
     * Example usage:
     * <code>
     * $query->filterByComputed('fooValue');   // WHERE computed = 'fooValue'
     * $query->filterByComputed('%fooValue%', Criteria::LIKE); // WHERE computed LIKE '%fooValue%'
     * </code>
     *
     * @param     string $computed The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildProductQuery The current query, for fluid interface
     */
    public function filterByComputed($computed = null, $comparison = null)
    {
        if (null === $comparison) {
        ...
        return $this->addUsingAlias(ProductTableMap::COL_COMPUTED, $computed, $comparison);
    }
    ...
    {
        if ($product) {
            $this->addUsingAlias(ProductTableMap::COL_SKU, $product->getSku(), Criteria::NOT_EQUAL);
        }
